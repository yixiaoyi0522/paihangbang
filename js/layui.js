...
! function(e) {
	...
	var n = document,
		...
		a = {
			...
			laydate: "../../lay/modules/laydate",
			laypage: "../../lay/modules/laypage",
			laytpl: "../../lay/modules/laytpl",
			layim: "../../lay/modules/layim",
			layedit: "../../lay/modules/layedit",
			form: "../../lay/modules/form",
			upload: "../../lay/modules/upload",
			tree: "../../lay/modules/tree",
			table: "../../lay/modules/table",
			element: "../../lay/modules/element",
			util: "../../lay/modules/util",
			flow: "../../lay/modules/flow",
			carousel: "../../lay/modules/carousel",
			code: "../../lay/modules/code",
			jquery: "../../lay/modules/jquery",
			mobile: "../../lay/modules/mobile",
